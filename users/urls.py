...
from .views import RegisterView, LoginView, ProfileView, AddRecordToCollectionView, AddRecordToWishlistView, RemoveRecordFromCollection, RemoveRecordFromWishlist
